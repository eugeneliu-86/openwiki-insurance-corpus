...
description: Determine the live HO-3 edition from the policy-written date, then assemble only compatible endorsements and Texas amendments verified in the issued policy. Includes the attachment-dependent HO 04 48 Coverage B increased-limit endorsement while keeping contractual terms, state constraints, and repository availability separate.
...
## Assemble the net-new HO 04 48 increased-limit endorsement

**HO 04 48 Other Structures on the Residence Premises — Increased Limits (2026-06)** is a net-new multistate endorsement: no earlier edition exists. It attaches to **HO-3 Edition 2018-09** and directs a narrow change—**HO 04 48 OS.1 modifies HO-3 2018-09 Coverage B B.2 only**. Its repository presence does not establish issuance. Apply it only when the issued-policy record verifies that this exact endorsement is attached to the compatible 2018-09 base policy; it is not a form-selection rule for HO-3 2011-05, and the source supplies no separate effective-date or underwriting-authority rule. [HO 04 48, status, attachment, and target](repo://forms/HO/MS/HO-04-48/2026-06.md#L1-L5) · [HO-3 2018-09 B.2](repo://forms/HO/MS/HO-3/2018-09.md#L35-L41)

When verified as attached, OS.1 replaces B.2's base 10%-of-Coverage-A calculation with the Coverage B limit shown for the endorsement in the Declarations. That declared amount must not be less than 10% of the Coverage A limit and remains additional insurance. Retain the endorsement Declarations limit to determine the changed limit; OS.3 separately locates the additional premium there. [HO 04 48 OS.1 and OS.3](repo://forms/HO/MS/HO-04-48/2026-06.md#L7-L11) · [HO 04 48 OS.3](repo://forms/HO/MS/HO-04-48/2026-06.md#L19-L23) · [HO-3 2018-09 B.2](repo://forms/HO/MS/HO-3/2018-09.md#L35-L41)

**OS.2 defines the preserved boundaries.** It does not modify Coverage B B.1 or B.3, any other Section I property coverage, or any Section I exclusion or condition; structures rented or held for rental remain subject to B.3. Accordingly, the endorsement changes the limit only—it neither broadens the covered-structure test nor removes the rental boundary, creates a coverage grant, writes back an exclusion, or displaces a condition. All other policy provisions apply. [HO 04 48 OS.2 and concluding clause](repo://forms/HO/MS/HO-04-48/2026-06.md#L13-L23) · [HO-3 2018-09 B.1-B.3](repo://forms/HO/MS/HO-3/2018-09.md#L35-L42)
...
flowchart TD
    ...
    Attached -- "Yes" --> Increased{"Attached form is HO 04 48"}
    Increased -- "Yes" --> BTwo{"Selected base is HO-3 2018-09 with B.2"}
    BTwo -- "No" --> Exclude
    BTwo -- "Yes" --> IncreasedTerms["Apply OS.1 declared limit and preserve OS.2 boundaries"]
    Increased -- "No" --> Water{"Attached form is HO 04 90"}
...
*The assembly flow selects the HO-3 base edition from its written-date rule, verifies attachment, tests HO 04 48's directed 2018-09 B.2 target before applying OS.1 and OS.2, then selects a verified HO 04 90 from its separate written-date rule. It admits only verified compatible forms and gives an in-scope attached Texas amendment effect only at a conflicting provision.* [HO 04 48, attachment target and OS.1-OS.2](repo://forms/HO/MS/HO-04-48/2026-06.md#L1-L17) · [HO-3 2011-05, applicability and continuing force](repo://forms/HO/MS/HO-3/2011-05.md#L3-L7) · [HO-3 2018-09, applicability](repo://forms/HO/MS/HO-3/2018-09.md#L1-L4) · [HO 04 90 2010-10, continuing force](repo://forms/HO/MS/HO-04-90/2010-10.md#L1-L7) · [HO 04 90 2026-01, replacement rule](repo://forms/HO/MS/HO-04-90/2026-01.md#L1-L4) · [HO 01 45, attachment, effective-date scope, and conflict rule](repo://forms/HO/TX/HO-01-45/2022-01.md#L1-L4)
...
4. **Match the directed target.** Confirm that the endorsement's target provision exists and has the stated function in the selected edition. For HO 04 48, verify the 2018-09 base and B.2 target before applying OS.1; B.2's replacement is a declared-limit change, while OS.2 preserves B.1, B.3, the remaining property coverages, exclusions, and conditions. Do not infer compatibility from a shared HO-3 form number or the repository's inventory. [HO 04 48 OS.1-OS.2](repo://forms/HO/MS/HO-04-48/2026-06.md#L7-L17) · [HO-3 2018-09 B.1-B.3](repo://forms/HO/MS/HO-3/2018-09.md#L35-L42)
5. **Apply the correct layer in dependency order.** Establish the selected base grant and exclusions; apply a verified narrow write-back and its preserved barriers; then apply its limit, deductible, condition, and settlement mechanics. An attached HO 04 48 changes B.2 only after the B.1/B.3 scope and the ordinary grant/exclusion analysis remain in place. Apply an attached in-scope state amendment where it conflicts with the base provision. A settlement term never becomes the initial coverage grant merely because it is attached. [HO 04 16 O.1 and O.6](repo://forms/HO/MS/HO-04-16/2018-09.md#L5-L9) · [HO 04 16 O.6](repo://forms/HO/MS/HO-04-16/2018-09.md#L33-L37) · [HO 23 74 R.1-R.2](repo://forms/HO/MS/HO-23-74/2018-09.md#L5-L15) · [HO 04 48 OS.1-OS.2](repo://forms/HO/MS/HO-04-48/2026-06.md#L7-L17) · [HO 01 45, conflict rule](repo://forms/HO/TX/HO-01-45/2022-01.md#L1-L4)
...
| --- | --- | --- |
| **HO 04 48 2026-06 OS.1 modifies HO-3 2018-09 Coverage B B.2 only.** | When this net-new endorsement is verified attached to that compatible base form, OS.1 replaces B.2 with the Coverage B limit shown for the endorsement in the Declarations. The declared amount may not be less than 10% of Coverage A and is additional insurance. The form provides no earlier edition, effective-date, or underwriting-authority rule; repository availability never proves attachment. [HO 04 48, status and target](repo://forms/HO/MS/HO-04-48/2026-06.md#L1-L5) · [HO 04 48 OS.1](repo://forms/HO/MS/HO-04-48/2026-06.md#L7-L11) · [HO-3 2018-09 B.2](repo://forms/HO/MS/HO-3/2018-09.md#L35-L41) | **HO 04 48 OS.2 preserves the boundaries:** B.1 and B.3, every other Section I property coverage, and every Section I exclusion and condition remain unchanged; rental or held-for-rental structures remain subject to B.3. Thus no increased limit can expand property scope, remove the rental limitation, or create coverage for excluded loss. OS.3 puts the additional premium in the Declarations, and all other policy provisions apply. [HO 04 48 OS.2-OS.3 and concluding clause](repo://forms/HO/MS/HO-04-48/2026-06.md#L13-L23) · [HO-3 2018-09 B.1-B.3](repo://forms/HO/MS/HO-3/2018-09.md#L35-L42) |
...
5. **Other-structure increased limit:** Verify HO-3 2018-09, the issued attachment of HO 04 48 2026-06, the endorsement Declarations limit, and the Coverage A limit. Confirm the declared limit is at least 10% of Coverage A, then separately apply the unchanged B.1 structure test, B.3 rental boundary, Section I exclusions, and conditions. Do not create an effective-date or underwriting test for this net-new form from repository presence. [HO 04 48, status and OS.1-OS.2](repo://forms/HO/MS/HO-04-48/2026-06.md#L1-L17) · [HO-3 2018-09 B.1-B.3](repo://forms/HO/MS/HO-3/2018-09.md#L35-L42)
