...
```mermaid
flowchart TD
    A["Identify policy effective date"] --> B{"Which HO-3 edition governs"}
    B -->|"Before 2018-09-01"| C["2011-05 form"]
    B -->|"2018-09-01 through 2024-02-29"| D["2018-09 form"]
    B -->|"2024-03-01 or later"| E["2024-03 form"]
    C --> F["Read declarations and attached endorsements"]
    D --> F
    E --> F
    F --> G["Apply form text then endorsement text"]
    G --> H["Adjust covered loss under the applicable edition"]
```
