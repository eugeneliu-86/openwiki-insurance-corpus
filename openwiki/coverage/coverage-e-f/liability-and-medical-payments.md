...
description: Edition-aware guide to HO-3 Coverage E personal liability and Coverage F medical payments to others. Separates the Section II grants from the edition-specific exclusions that control defense, indemnity, and payment decisions.
tags: [homeowners, coverage-e, coverage-f, personal-liability, medical-payments, section-ii]
verified:
  - by: openwiki/0.5.0
