---
type: coverage
title: Wind and Hail Deductibles
description: How homeowners and dwelling policies determine whether a covered wind or hail loss is subject to a percentage deductible, including coverage gates, calculation basis, occurrence rules, other deductibles, notice, and state overlays.
...
The **Declarations and attached policy form or endorsement impose the deductible** for the insured contract. A state amendatory endorsement can modify that contract within its stated scope; the state bulletin is a regulatory overlay for disclosure, filing, notice, and claims administration, not a free-standing payment term. Carrier underwriting manuals and endorsement-attachment rules are internal selection and issuance controls: they may restrict which option the carrier offers or attaches, but they do not change the deductible shown in the issued policy or create claim coverage ([Texas state-overlay contract and regulatory boundary](repo://openwiki/state-overlays/texas.md#L25-L29), [underwriting manual boundary](repo://manuals/underwriting/manual.md#L21-L37)).
...
|---|---|---|
| HO 23 77, 2014-02 | Selected percentage is **1% to 5%**. Deductible uses the applicable coverage limit for damaged property. | Applies to each windstorm or hail loss and is separate from another-peril deductible; the older edition remains live for policies written under it ([W.1-W.11](repo://forms/HO/MS/HO-23-77/2014-02.md#L47-L67), [edition marker](repo://forms/HO/MS/HO-23-77/2014-02.md#L1-L9)). |
| HO 23 77, 2022-07 | Selected percentage is **2% to 10%**. Applicable limit is the limit for damaged property immediately before loss. | Same occurrence or related weather event controls; separate limits are not combined unless the applicable basis requires it ([W.3-W.6 and W.33-W.35](repo://forms/HO/MS/HO-23-77/2022-07.md#L655-L676), [repo://forms/HO/MS/HO-23-77/2022-07.md#L217-L229]). |
| Florida DP 01 09, 2021-03 | Windstorm and hail deductible is **2% to 10%** and uses the amount of insurance applicable to damaged property. | Applied to the covered loss for the occurrence and not reduced because multiple items are damaged. The form requires at least **45 days' notice** before an increase ([DP 01 09 Florida 2021-03, T.1-T.7](repo://forms/DP/FL/DP-01-09/2021-03.md#L97-L123), [T.2 notice](repo://forms/DP/FL/DP-01-09/2021-03.md#L318-L335)). |
...
| Texas HO 01 45, 2022-01 | Windstorm and hail deductible is **1% to 10%**. | Applies to covered direct physical loss, including resulting covered damage, and uses the applicable limit of liability for the damaged property; the form requires **45 days' notice** before an increase ([HO 01 45 Texas 2022-01, T.1-T.15](repo://forms/HO/TX/HO-01-45/2022-01.md#L61-L89), [T.2 notice](repo://forms/HO/TX/HO-01-45/2022-01.md#L169-L183)). |
| Texas DP 01 45, 2022-01 | Windstorm and hail deductible shown in the Declarations is **1% to 5%**. | Uses the applicable amount of insurance and applies to the covered loss from the occurrence; the form requires **30 days' notice** before an increase ([DP 01 45 Texas 2022-01, T.1-T.9](repo://forms/DP/TX/DP-01-45/2022-01.md#L94-L128), [T.2 notice](repo://forms/DP/TX/DP-01-45/2022-01.md#L380-L398)). |
