...
generated: { by: "openwiki/0.5.0", at: "2026-09-13T01:00:32.701Z" }
verified:
  - by: openwiki/0.5.0
    at: 2026-09-13T01:00:32.701Z
---
...
Collect the policy-written date, policy effective date, state, full Declarations, limits, deductible selections, selected HO-3 edition, and every actually attached form and edition. When an other-structures limit is asserted, verify the HO 04 48 attachment, that the selected base form is HO-3 2018-09, and the endorsement limit shown in the Declarations; when water backup is asserted, identify the exact HO 04 90 edition. For a claim, also collect the loss date, alleged cause, property involved, and facts needed by the potentially applicable provision. If a required record or attachment is unverified, leave the affected issue unresolved rather than importing a later form or assuming attachment. [HO 04 48, attachment target and OS.1](repo://forms/HO/MS/HO-04-48/2026-06.md#L3-L11)
...
## HO 04 48 other-structures limit: verify before answering

**Contract route.** Send an other-structures limit question to [Coverage B — Other Structures](/openwiki/coverage/coverage-b/other-structures.md). HO 04 48 is a net-new multistate endorsement that attaches to **HO-3 2018-09** and **modifies Coverage B.2 only**; the repository form therefore establishes neither an issued attachment nor compatibility with HO-3 2011-05. [HO 04 48, scope, target, and status](repo://forms/HO/MS/HO-04-48/2026-06.md#L1-L5) · [HO-3 2018-09, Coverage B.2](repo://forms/HO/MS/HO-3/2018-09.md#L35-L41)

Before giving a contract answer, verify the issued HO-3 2018-09 policy, the attached HO 04 48 endorsement, and the endorsement limit in the Declarations. For that verified attachment, OS.1 replaces B.2's base 10%-of-Coverage-A limit with the Declarations amount, which may not be less than 10% of Coverage A and is additional insurance. OS.2 leaves B.1 and B.3, other Section I property coverages, exclusions, and conditions unchanged; an increased limit neither expands covered property nor removes the rental, exclusion, or condition gates. The additional-premium entry is distinct from the limit. [HO 04 48, OS.1-OS.3](repo://forms/HO/MS/HO-04-48/2026-06.md#L7-L23) · [HO-3 2018-09, Coverage B](repo://forms/HO/MS/HO-3/2018-09.md#L35-L42)

**Unverified record:** obtain the policy attachment and Declarations rather than treating repository availability, an underwriting request, or an additional-premium entry as proof of attachment or of the contractual limit. Route proposed binding or authority questions—not the contract result—to [Referral and Binding Authority](/openwiki/underwriting/referral-and-binding-authority.md). [HO 04 48, OS.1 and OS.3](repo://forms/HO/MS/HO-04-48/2026-06.md#L7-L11) · [HO 04 48, OS.3](repo://forms/HO/MS/HO-04-48/2026-06.md#L19-L23)
...
| **Coverage B** | Detached structures, fence or utility connections, rental use, or an HO 04 48 increased-limit question (attachment, HO-3 2018-09 compatibility, or Declarations amount) | [Coverage B — Other Structures](/openwiki/coverage/coverage-b/other-structures.md) |
...
| --- | --- |
| **HO 04 48 OS.1 modifies HO-3 2018-09 Coverage B.2 only when the endorsement is verified attached.** [HO 04 48, attachment target and OS.1](repo://forms/HO/MS/HO-04-48/2026-06.md#L3-L11) · [HO-3 2018-09, Coverage B.2](repo://forms/HO/MS/HO-3/2018-09.md#L35-L41) | Route an other-structures limit question to Coverage B. Verify the attachment and Declarations limit; OS.2 retains B.1/B.3, other property coverages, exclusions, and conditions, so do not treat the increase as a broader Coverage B change. [HO 04 48, OS.2](repo://forms/HO/MS/HO-04-48/2026-06.md#L13-L17) |
...
1. **Assembly:** the issued record establishes dates, state, Declarations, base edition, and each attachment; for an asserted HO 04 48 limit, it also establishes the HO-3 2018-09 base, attached endorsement, and endorsement Declarations amount. [HO 04 48, attachment target and OS.1](repo://forms/HO/MS/HO-04-48/2026-06.md#L3-L11)
