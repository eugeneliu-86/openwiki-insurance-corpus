...
description: Florida OIR-2023-04 constraints on roof-age underwriting, inspections, ACV roof schedule offers, nonrenewal notices, deductible overlap, and county reporting for personal residential property.
...
# Florida Roof Age, ACV Schedule, and Nonrenewal Overlay

## Scope, effective-date gate, and authority boundary

Florida Office of Insurance Regulation Bulletin OIR-2023-04 applies to personal residential property policies issued or renewed in Florida with an effective date on or after 2023-07-01. It regulates an insurer's use of roof age in issuance and renewal decisions, roof inspections, roof deductibles, ACV roof settlement schedules, nonrenewal notice content, and annual reporting. Apply the effective-date gate before using the bulletin as the governing regulatory overlay. [OIR-2023-04, applicability and purpose](repo://bulletins/FL/2023-04-roof-age-nonrenewal.md#L1-L7)

> **Authority boundary.** The bulletin is a regulatory overlay, not policy contract language. It does not attach an endorsement, choose a deductible stated in the Declarations, establish coverage for a reported loss, or replace the settlement wording in the issued form. Internal Florida appetite and referral documents are underwriting controls only and are not policy language. [OIR-2023-04, purpose](repo://bulletins/FL/2023-04-roof-age-nonrenewal.md#L5-L7) · [Florida Homeowners Appetite Guide, status](repo://guidelines/appetite/fl-homeowners.md#L1-L5) · [Underwriting Referral and Authority Matrix, status](repo://guidelines/authority/referral-matrix.md#L1-L5)

For HO-3 2018-09, dwelling losses have a replacement-cost baseline subject to A.3 and the applicable deductible. A.4 moves windstorm- or hail-caused roof-surfacing loss to an ACV schedule only when HO 23 74 is actually attached; other dwelling components remain under A.3. A Florida offer that satisfies the bulletin is therefore not proof that HO 23 74 was issued on a particular policy. Verify the issued Declarations and endorsement attachment before settling a claim. [HO-3 2018-09, A.3–A.4](repo://forms/HO/MS/HO-3/2018-09.md#L25-L34) · [HO 23 74 2018-09, attachment and scope](repo://forms/HO/MS/HO-23-74/2018-09.md#L1-L10)

## Issuance and renewal: roof age, useful life, and inspection

An insurer may not refuse to issue or refuse to renew solely because of roof age when an inspection performed by an authorized inspector within the 12 months before the effective date establishes that the roof has five years or more of remaining useful life. This is not a rule that every older roof must be accepted; it constrains the stated basis for the issuance or renewal decision when the bulletin's inspection and useful-life facts are present. [OIR-2023-04, F.2](repo://bulletins/FL/2023-04-roof-age-nonrenewal.md#L9-L13)

When declining a risk on roof condition, the insurer must state the specific deficiency identified and may not state roof age alone as the reason. Preserve the condition finding and use that finding, not a generic age label, in the declination explanation. The internal referral matrix repeats this documentation standard, but the bulletin supplies the regulatory requirement. [OIR-2023-04, F.2](repo://bulletins/FL/2023-04-roof-age-nonrenewal.md#L11-L13) · [Underwriting Referral and Authority Matrix, R.6](repo://guidelines/authority/referral-matrix.md#L49-L53)
...
If the insured obtains and provides an inspection meeting F.2, the insurer must accept it and may not require a second inspection at the insured's expense in the same policy period. The insurer must also accept an inspection performed by a Florida-licensed inspector and may not limit acceptance to inspectors selected by the insurer. Retain the report, inspector qualification, inspection date, stated remaining useful life, and policy effective date so the 12-month and five-year tests can be reviewed. [OIR-2023-04, F.2–F.3](repo://bulletins/FL/2023-04-roof-age-nonrenewal.md#L9-L19)

The Florida appetite guide adds an internal before-binding inspection requirement for roofs 15 years old or older, and the referral matrix adds referral triggers for roof surfacing aged 20 years or more and for any roof aged 25 years or more regardless of documentation. These are carrier workflow and escalation controls; they do not expand the bulletin's F.3 inspection right, replace F.2's decision-basis test, or establish a settlement term. [Florida Homeowners Appetite Guide, H.2](repo://guidelines/appetite/fl-homeowners.md#L15-L21) · [Underwriting Referral and Authority Matrix, R.3](repo://guidelines/authority/referral-matrix.md#L19-L31)
...
1. **Applicability:** Is this a Florida personal residential property policy being issued or renewed with an effective date on or after 2023-07-01? If not, do not assume OIR-2023-04 supplies the applicable rule.
