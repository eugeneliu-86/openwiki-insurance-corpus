...
DOI-2019-05 requires filing controls for policy forms, endorsements, deductible provisions, rules, rates, rating plans, and supporting notices that establish or change a hail deductible. The filing must identify the affected coverage, trigger, calculation method, underwriting and rating effect, and notice or disclosure materials. Material revisions must be filed before use, and the insurer may not apply the provision before the authorized effective date ([DOI-2019-05, B.5.1-B.5.11](repo://bulletins/CO/doi-2019-05-hail-deductibles.md#L583-L634)). DOI-2013-01 expressly requires Department approval before use, preserves the insurer's responsibility for lawful, nonmisleading administration, and says inaction is not approval ([DOI-2013-01, B.5.1-B.5.16](repo://bulletins/CO/doi-2013-01-hail-deductibles.md#L522-L593)).
...
Before applying the deductible, the insurer must identify the policy provision, explain the effect on payment, provide a clear calculation, and determine whether the damage arose from one or distinct occurrences. The insurer must not apply the deductible more than the policy permits ([DOI-2019-05, B.4.4-B.4.14](repo://bulletins/CO/doi-2019-05-hail-deductibles.md#L482-L492)). Denials and limitations require written policy and factual explanations. The insurer must consider relevant estimates, photographs, contractor information, reinspection requests, and supplemental damage; it may not require a particular contractor or withhold an undisputed covered amount because another portion remains disputed ([DOI-2019-05, B.4.15-B.4.27](repo://bulletins/CO/doi-2019-05-hail-deductibles.md#L517-L565)).
