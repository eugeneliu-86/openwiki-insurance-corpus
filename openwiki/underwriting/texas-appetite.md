...
*This internal sequence applies Texas risk-selection and routing controls before binding. It does not establish whether an issued policy covers a loss.* [Texas Homeowners Appetite Guide, G.1-G.7](repo://guidelines/appetite/tx-homeowners.md#L7-L49) · [Underwriting Referral and Authority Matrix, R.1-R.6](repo://guidelines/authority/referral-matrix.md#L7-L53)
...
When HO 01 45 is attached and applicable, T.1 supplies contractual percentage wording and governs a conflict with HO-3. Its separate wind/hail deductible is stated in the Declarations as a percentage of Coverage A, subject to the same 1%–5% range and 10% seacoast maximum. The bulletin's flat-dollar permission is a regulatory option; it is not language that HO 01 45 automatically adds to a policy. [HO 01 45, conflict rule and T.1](repo://forms/HO/TX/HO-01-45/2022-01.md#L1-L11) · [Texas Bulletin B-2021-08, B.2](repo://bulletins/TX/2021-08-windstorm-deductible.md#L9-L13)
